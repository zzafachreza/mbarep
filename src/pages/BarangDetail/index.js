            ...
            <View
                ...
                {!keyboardStatus && <View style={{
                    ...
                    <Text
                        ...
                        Stok : {new Intl.NumberFormat().format(item.stok)}
                    </Text>
                </View>
                }
                <View
                ...
                <View style={{ margin: 10, }}>
                    <MyButton onPress={addToCart} warna={colors.primary} title={"Rp. " + new Intl.NumberFormat().format(item.harga_barang * jumlah) + " - Masukan Keranjang"} Icons="cart" />
                </View>
            </View>
